 ...
 *YES
 */
@Autonomous(name= "opencvSkystoneDetector", group="AutoOP")
//@Disabled//comment out this line before using
public class opencvSkystoneDetector extends robot {
    ...
    private static float[] midPos = {4f/8f+offsetX, 5f/8f+offsetY};//0 = col, 1 = row
    private static float[] leftPos = {2.35f/8f+offsetX, 5f/8f+offsetY};//изменение параметров= передвижение всех объектов
    private static float[] rightPos = {5.65f/8f+offsetX, 5f/8f+offsetY};
...
//            moveDistance(0.4, 700);
        ...
        waitForStart();{
            int m5startposition= m5Lift.getCurrentPosition();
            int m5currentposition=m5Lift.getCurrentPosition();

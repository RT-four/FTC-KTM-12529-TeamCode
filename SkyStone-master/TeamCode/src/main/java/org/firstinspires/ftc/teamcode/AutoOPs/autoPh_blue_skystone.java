 ...
 *YES
 */
@Autonomous(name= "autoPh_blue_skystone", group="AutoOP")
//@Disabled//comment out this line before using
public class autoPh_blue_skystone extends robot {
...
//            moveDistance(0.4, 700);
        ...
        waitForStart();{
            ...
            time1=getRuntime();
            time2=getRuntime();
            while(time2-time1<0.6*pologenieskystone1+0.5){
            ...
            setMotorsPowerTimed(0.4*koeff,-0.4*koeff,-0.4*koeff,0.4*koeff,200);//nazad
            time1=getRuntime();
            time2=getRuntime();
            while(time2-time1<0.6*pologenieskystone1+0.5){
            ...
            //setMotorsPowerTimed(-0.4*koeff,0.4*koeff,-0.4*koeff,0.4*koeff,1600);//vpravo
            //sleep(200);
            time1=getRuntime();
            time2=getRuntime();
            while(time2-time1<1.6){
            ...
            time1=getRuntime();
            time2=getRuntime();
            while(time2-time1<0.6*pologenieskystone1+1.2){
                setMotorsPowerforvard(-0.8*koeff,0.8*koeff,0.8*koeff,-0.8*koeff,angles, imu, 90);
                time2=getRuntime();
            }
            //setMotorsPower(0,0,0,0);
            ...
            sleep(100);
            otpustiskystone();
            setMotorsPowerTimed(0.3*koeff,-0.3*koeff,-0.3*koeff,0.3*koeff,1500);//nazad
            sleep(100);
        }
    }
    //------------------------------------------------------------------------------------------------------------------
